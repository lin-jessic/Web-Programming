    ...
    <div className="sp-page">
      ...
      <div className="sp-layout">
        ...
        <main className="sp-canvas-wrap">
          <div
            ref={canvasRef}
            className={`sp-canvas sp-style-${styleName} ${drawingMode && eraserMode !== "object" ? "sp-drawing-mode" : ""} ${drawingMode && eraserMode === "object" ? "sp-object-eraser-mode" : ""}`}
            style={{
...
/* Drawing fix: existing full-canvas drawing strokes should not block the next stroke. */
.sp-canvas.sp-drawing-mode .sp-item,
.sp-canvas.sp-drawing-mode .sp-item * {
  pointer-events: none !important;
}

/* Object eraser keeps only drawing strokes clickable while other materials stay protected. */
.sp-canvas.sp-object-eraser-mode .sp-item {
  pointer-events: none !important;
}
.sp-canvas.sp-object-eraser-mode .sp-item-drawing,
.sp-canvas.sp-object-eraser-mode .sp-item-drawing * {
